...
export function Scene({
  ...
  return (
    <section className="relative flex min-h-[100svh] flex-col justify-end overflow-hidden">
        ...
        <>
          ...
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center pb-40">
            ...
            <Image
              ...
              className="h-[min(38vh,320px)] w-auto rounded-[22%] shadow-[0_30px_80px_rgb(0_0_0/0.6)]"
            />
          </div>
        </>
      )}
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 pb-24 pt-40 sm:pb-28">
        {eyebrow && (
        ...
        <h2 className="display mt-4 max-w-[16ch] text-[clamp(2.4rem,7vw,5rem)]" lang="en">
          {title}
        </h2>
        {lead && (
          <p className="mt-5 max-w-[46ch] text-[15px] leading-relaxed text-dim">{lead}</p>
        )}
